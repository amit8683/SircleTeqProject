...
const MagmaSATP = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("http://localhost:5001/satp", formData);
      setData(res.data.result.slice(1));
      console.log(res.data.fullUppperHeader);
      setUpperHeader(res.data.fullUppperHeader);
    } catch (error) {
  ...
  const downloadExcel = () => {
    const headerRow1 = [
        'Biz Vol <=3 Lacs', 'Biz Mix 3', 'TP GCV 3W', 'TP GCV <=2.5 T', 'TP GCV 2.5 T - 2.8T', 'TP GCV 2.8 T - 3.5T',
        'TP GCV 3.5T - 7.5T', 'TP GCV 7.5T - 12T', 'TP GCV 12T - 20T', null, 'TP GCV 20T - 40T', null, 'TP GCV > 40T',
        'TP_PVT-CAR', null, null, null, null, null, 'TP_Taxi', 'TP-2W', null, null, null, null,
        'TP-Bus', null, 'TP-CE', null, null, null, null, 'TP-PCV-3W', null, null, 'TP-Tractor'
      ];
    
      const headerRow2 = [
        null, 'Budget Biz Mix', 'TP GCV 3W', 'TP GCV <=2.5 T', 'TP GCV 2.5 T - 2.8T', 'TP GCV 2.8 T - 3.5T',
        'TP GCV 3.5T - 7.5T', 'TP GCV 7.5T - 12T', 'TP GCV 12T-20T Age<5', 'TP GCV 12T-20T Age>=5',
        'TP GCV 20T-40T Age<5', 'TP GCV 20T-40T Age>=5', 'TP GCV > 40T', 'TP_PVT-CAR(<1000cc Diesel)',
        'TP_PVT-CAR(<1000cc Petrol)', 'TP_PVT-CAR(1000-1500cc Diesel)', 'TP_PVT-CAR(1000-1500cc Petrol)',
        'TP_PVT-CAR(>1500cc Diesel)', 'TP_PVT-CAR(>1500cc Petrol)', 'TP_Taxi', '<=75cc', '75-150cc', '150-350cc',
        '>350cc', 'Scooter', 'PCV-Bus_Other', 'PCV-Bus_School', 'Harvester New', 'Harvester Old', 'CE', 'MISD Garbage',
        'Misc-D Others', 'PCV 3W Electric', 'PCV 3W New', 'PCV 3W Old', 'Tractor New', 'Tractor Old'
      ];
    
      const headerRow3 = [
        'Cluster State', 'UW Cluster/Outgo', 'GWP', 'GWP', 'GWP', 'GWP', 'GWP', 'GWP', 'GWP', 'GWP',
    ...
    XLSX.writeFile(wb, "magma_satp.xlsx");
  };
  ...
  const downloadOnlyChanges = () => {
    ...
    XLSX.writeFile(wb, "magma_satp_changes.xlsx");
  };
